...
const Header = () => {
    ...
    return (
        <header id='header'>
            <div className='content-container bg-purple'>
                <div className='content text-light flex justify-between items-center'>
                    <div className='logo flex gap-2 items-center cursor-pointer' onClick={() => navigate("/")}>
                        <FcWorkflow  size={30} />
                        <span className='bg-purple text-offbrown text-[1.25rem] font-bold'>
                            JOB CHAIYE ?
                        </span>
                    </div>
                    <div className='search-bar grow'>
                        <form className="max-w-md mx-auto">
                            ...
                            <div className="relative">
                                ...
                                <button type="submit" className="text-white absolute end-0 top-1/2 -translate-y-1/2 bg-offbrown hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-third dark:focus:ring-blue-800">Search</button>
                            </div>
                        </form>
                    </div>
                            ...
                            user.logedIn ?
                                <span className='flex gap-2 items-center'>
                                    <span className='font-bold'>
                                        Welcome,</span>
                                    <span className='text-offbrown flex items-center gap-1'>
                                        {user.name}
                                ...
                                <span className='cursor-pointer' onClick={() => { navigate("/user-login-register") }}>Please
                                    <span className='text-light'> Login/Register !</span>
                                </span>
                        }
                    </div>
                </div>
